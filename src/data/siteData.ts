export const category = {
  web: {
    ...
    images: [
      ...
      { image: "/assets/icons/dj.svg", alt: "Django", class: "" },
  ...
  "data-analysis": {
    ...
    images: [
      { image: "/assets/icons/kobo.svg", alt: "Kobotoolbox", class: "" },
      { image: "/assets/icons/enketo.svg", alt: "Enketo", class: "" },
      { image: "/assets/icons/ona.svg", alt: "ONA", class: "" },
      { image: "/assets/icons/odk.svg", alt: "ODK Collect", class: "" },
      { image: "/assets/icons/power_bi.svg", alt: "Power BI", class: "" },
      { image: "/assets/icons/looker.svg", alt: "Looker", class: "" },
      { image: "/assets/icons/tableau.svg", alt: "Tableau", class: "" },
      { image: "/assets/icons/g_analitics.svg", alt: "Google Analytics", class: "" },
    ]
  },
  advertising: {
    title: "Publicidad",
    images: [
      ...
      { image: "/assets/icons/audition.svg", alt: "Audition", class: "" },
      { image: "/assets/icons/audacity.svg", alt: "Audacity", class: "" },
...
export const services = [
  {
    ...
    logo: "/assets/images/pagina13.webp",
    ...
    technologies: [
      { name: "Looker studio", icono: "/assets/icons/looker.svg" },
      { name: "Power BI", icono: "/assets/icons/power_bi.svg" },
      { name: "Tableau", icono: "/assets/icons/tableau.svg" },
      { name: "Kobotoolbox", icono: "/assets/icons/kobo.svg" },
      { name: "ONA", icono: "/assets/icons/ona.svg" },
      { name: "ODK Collect", icono: "/assets/icons/odk.svg" },
      { name: "Enketo", icono: "/assets/icons/enketo.svg" },
      { name: "MySql", icono: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg" },
    ],
    images: [
      { image: "/assets/images/pagina13.webp", alt: "Dashboard de análisis financiero empresarial con métricas y gráficos interactivos" },
      { image: "/assets/images/pagina14.webp", alt: "Panel de control y reportes de rendimiento para empresas" },
      { image: "/assets/images/pagina16.webp", alt: "Interfaz de monitoreo y gestión de datos con análisis de tendencias" },
      { image: "/assets/images/pagina15.webp", alt: "Mapa interactivo para análisis geoespacial de datos empresariales" },
    ],
  },
  {
    id: "2",
    ...
    logo: "/assets/images/pagina4.webp",
    ...
    images: [
      { image: "/assets/images/pagina1.webp", alt: "Página web de heladería con diseño moderno y atractiva experiencia de usuario" },
      { image: "/assets/images/pagina4.webp", alt: "Sitio web para cafetería con estilo elegante y optimizado para negocios" },
      { image: "/assets/images/pagina8.webp", alt: "Portafolio web profesional para freelancers y creativos" },
      { image: "/assets/images/pagina11.webp", alt: "Sitio web de bodas con diseño personalizado y elegante" },
    ],
  },
  {
    id: "3",
    ...
    logo: "/assets/images/pagina19.webp",
    ...
    technologies: [
      { name: "MySql", icono: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg" },
      { name: "ODK", icono: "/assets/icons/odk.svg" },
      { name: "Enketo", icono: "/assets/icons/enketo.svg" },
      { name: "PostgreSQL", icono: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-original.svg" },
    ],
    images: [
      { image: "/assets/images/pagina20.webp", alt: "Interfaz de inicio de sesión seguro para plataforma" },
      { image: "/assets/images/pagina19.webp", alt: "Panel de análisis de datos con gráficos y reportes estadísticos" },
      { image: "/assets/images/pagina18.webp", alt: "Sistema de administración de bases de datos con visualización de registros" },
      { image: "/assets/images/pagina17.webp", alt: "Diagrama entidad-relación para modelado y diseño de bases de datos" },
    ],
  },
  {
    id: "4",
    ...
    logo: "/assets/images/pagina23.webp",
    ...
    technologies: [
      { alt: "Adobe Photoshop", icono: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/photoshop/photoshop-original.svg" },
      { alt: "Adobe Aftereffects", icono: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/aftereffects/aftereffects-original.svg" },
      { alt: "Adobe Premier", icono: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/premierepro/premierepro-original.svg" },
      { alt: "Adobe Illustrator", icono: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/illustrator/illustrator-line.svg" },
      { alt: "Audition", icono: "/assets/icons/audition.svg" },
      { alt: "Audacity", icono: "/assets/icons/audacity.svg" },
      { alt: "Blender", icono: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/blender/blender-original.svg" },
    ],
    images: [
      { image: "/assets/images/pagina23.webp", alt: "Fotografía creativa con enfoque artístico y composición visual" },
      { image: "/assets/images/pagina22.webp", alt: "Diseño gráfico de anuncio publicitario para promoción de hamburguesas" },
      { image: "/assets/images/pagina21.webp", alt: "Edición de video profesional en software de postproducción" },
      { image: "/assets/images/pagina24.webp", alt: "Modelado y animación 3D en software de diseño digital" },
    ],
  }
];
...
export const projects = [
  {
    ...
    category: "web",
    title: "REDCICLAR",
    logo: "/assets/images/projects/icrese.png",
    ...
    client: [
      { image: "/assets/images/projects/icrese.png", alt: "Fundación CRESE", class: "h-25" },
    ],
    images: [
      { image: "/assets/images/projects/cliente3.webp", alt: "Sistema REDCICLAR - Dashboard de conteo y seguimiento por productos reciclados" },
      { image: "/assets/images/projects/cliente4.webp", alt: "Sistema REDCICLAR - Gestión de recolecciones y soporte de recibos para reciclaje eficiente" },
    ]
  },
  {
    id: "3",
    ...
    logo: "/assets/images/projects/imakikuna.png",
    ...
    client: [
      { image: "/assets/images/projects/imakikuna.png", alt: "Fundación Makikuna", class: "h-25" }
    ],
    images: [
      { image: "/assets/images/projects/clientes9.webp", alt: "Diseño de dashboard interactivo para el seguimiento de indicadores clave" },
      { image: "/assets/images/projects/clientes10.webp", alt: "Dashboard interactivo - Salidas gráficas para presentación y análisis de informes" },
    ]
  },
  {
    id: "4",
    ...
    logo: "/assets/images/projects/icasa_de_bosque.png",
    ...
    client: [
      { image: "/assets/images/projects/casa_de_bosque.webp", alt: "Case del bosque", class: "h-20" },
      { image: "/assets/images/projects/ifabrica_cuentos.png", alt: "Fabrica_Cuentos", class: "h-22 w-40" }
    ],
    images: [
      { image: "/assets/images/projects/clientes11.webp", alt: "Diseño de introducción visual para el proyecto Casa del Bosque" },
      { image: "/assets/images/projects/clientes12.webp", alt: "Proceso de edición de contenido audiovisual profesional" },
    ]
  },
];
