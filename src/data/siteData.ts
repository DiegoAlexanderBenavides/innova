...
export const category = {
  web: {
    ...
    images: [
      { image: `${base}/assets/icons/python.png`, alt: "Python", class: "" },
      { image: `${base}/assets/icons/javascript.png`, alt: "JavaScript", class: "" },
      { image: `${base}/assets/icons/html.png`, alt: "HTML", class: "" },
      { image: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/css3/css3-original.svg", alt: "CSS", class: "" },
      { image: `${base}/assets/icons/java.png`, alt: "Java", class: "" },
      { image: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/typescript/typescript-original.svg", alt: "TypeScript", class: "" },
      { image: `${base}/assets/icons/php.png`, alt: "PHP", class: "" },
      { image: `${base}/assets/icons/react.png`, alt: "React.js", class: "" },
      { image: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/angular/angular-original.svg", alt: "Angular", class: "" },
      { image: `${base}/assets/icons/vue.png`, alt: "Vue.js", class: "" },
      { image: `${base}/assets/icons/django.png`, alt: "Django", class: "" },
      { image: `${base}/assets/icons/springboot.png`, alt: "Spring Boot", class: "" },
      { image: `${base}/assets/icons/node.png`, alt: "Node js", class: "" },
    ]
  },
  "data-analysis": {
...
export const services = [
  ...
  },
  {
    ...
    technologies: [
      { name: "Python", icono: `${base}/assets/icons/python.png` },
      { name: "JavaScript", icono: `${base}/assets/icons/javascript.png` },
      { name: "HTML", icono: `${base}/assets/icons/html.png` },
      { name: "CSS", icono: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/css3/css3-original.svg" },
      { name: "PHP", icono: `${base}/assets/icons/php.png` },
      { name: "React", icono: `${base}/assets/icons/react.png` },
      { name: "Angular", icono: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/angular/angular-original.svg" },
      { name: "Node JS", icono: `${base}/assets/icons/node.png` },
    ],
    images: [
